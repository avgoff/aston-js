...
function myPromt() {
  ...
  if (
    !Number.isInteger(parsedNumCount) ||
    parsedNumCount < 2 ||
    parsedNumCount > 36
  ) {
    alert("Некорректный ввод!");
...
function selectFromInterval(arr, a, b) {
  ...
  return arr
    .filter((value) => value >= sortPos[0] && value <= sortPos[1])
    .sort((a, b) => a - b);
}
...
let myList1 = new SimlpleLinkedList();
myList1.append(1)
myList1.append(2)
myList1.append(3)
myList1.append(9)
console.log(myList1.size());//4
myList1.delete(2)
console.log(myList1);
